                              ...
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
										...
										<!-- <li class="sep"></li><li class="normal" id="tb_12" onclick="HoverLi(12);"><a href="/led/listAll.do" target="mainFrame">LED设置</a></li> -->
										<li class="sep"></li><li class="normal" id="tb_13" onclick="HoverLi(13);"><a href="/zone/zoneList.do" target="mainFrame">区域管理</a></li>
										<li class="sep"></li><li class="normal" id="tb_18" onclick="HoverLi(18);"><a href="/user/userList.do" target="mainFrame">用户管理</a></li>
										<li class="sep"></li><li class="normal" id="tb_14" onclick="HoverLi(14);"><a href="/house/houseList.do" target="mainFrame">温室管理</a></li>
										<!-- <li class="sep"></li><li class="normal" id="tb_15" onclick="HoverLi(15);"><a href="/equipment/equipmentList.do" target="mainFrame">设备管理</a></li> -->
										<!-- <li class="sep"></li><li class="normal" id="tb_16" onclick="HoverLi(16);"><a href="/camera/cameraList.do" target="mainFrame">摄像头管理</a></li> -->
										<!-- <li class="sep"></li><li class="normal" id="tb_17" onclick="HoverLi(17);"><a href="/nvr/nvrList.do" target="mainFrame">NVR管理</a></li> -->
										<li class="sep"></li><li class="normal" id="tb_20" onclick="HoverLi(20);"><a href="frame/sensor_main.do" target="mainFrame">传感器管理</a></li>
                                    </ul>
                                </td>
                              </tr>
                            </table>
