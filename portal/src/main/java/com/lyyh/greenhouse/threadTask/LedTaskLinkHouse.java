...
public class LedTaskLinkHouse implements Runnable{
	...
	public LedTaskLinkHouse(LedService ledService,int sleepTime,Integer zoneId,Integer programId) {
		super();
...
//			System.out.println("=======开始创建图片并发送plc======");
			...
			ledService.createImageAndSendToLedLinkHouse(zoneId, programId);
