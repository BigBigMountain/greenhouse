...
<title> User's Control Panel - powered by lyyh</title>
...
<div id="top">
     <div class="top">
          ...
          <tr>
            <td width="215"><div class="logo"><img  width="215" height="69" style="background-color: #4CA4E1"/></div></td>
            <td valign="top">
                <div class="topbg">
                     <div class="login-welcome">
                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                  	<%-- <td><%@ include file="date.jsp" %></td> --%>
                                    <td width="420" height="38">
                                    <img src="/images/admin/welconlogin-icon.png"/><span id="welcome">您好:${loginUser.username }!</span>
                                    <img src="/images/admin/loginout-icon.png"/><a href="/userController/logout.do" target="_top" id="logout" onclick="return confirm('您确定退出吗?');">退出</a> 
                              ...
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
										...
										<!-- <li class="sep"></li><li class="normal" id="tb_12" onclick="HoverLi(12);"><a href="/equipment/listAll.do" target="mainFrame">设备控制</a></li> -->
										<li class="sep"></li><li class="normal" id="tb_13" onclick="HoverLi(13);"><a href="frame/climatic_main.do" target="mainFrame">气象信息</a></li>
										<li class="sep"></li><li class="normal" id="tb_14" onclick="HoverLi(14);"><a href="frame/houseData_main.do" target="mainFrame">环境数据</a></li>
										<!-- <li class="sep"></li><li class="normal" id="tb_15" onclick="HoverLi(15);"><a href="frame/cameraManage_32.do" target="mainFrame">监控管理</a></li> -->
										<!-- <li class="sep"></li><li class="normal" id="tb_16" onclick="HoverLi(16);"><a href="frame/setting_main.do" target="mainFrame">系统设置</a></li>
                                    	<li class="sep"></li><li class="normal" id="tb_17" onclick="HoverLi(17);"><a href="frame/controllerSetting_main.do" target="mainFrame">温室设置</a></li> -->
                                    	<li class="sep"></li><li class="normal" id="tb_18" onclick="HoverLi(18);"><a href="/led/listAll.do" target="mainFrame">LED设置</a></li>
                                    	<!-- <li class="sep"></li><li class="normal" id="tb_19" onclick="HoverLi(19);"><a href="frame/fertilizer_main.do" target="mainFrame">施肥机</a></li> -->
                                    </ul>
                                </td>
                              </tr>
                            </table>
